package com.wordpress.antonio.newcarshop.batchap.service;
...
public class CarroService {
    ...
    private static final String A_CADA__HR_T_OS_DIAS = "0 0 * * * *";
    private static final String AS_6_E_AS_18_HRS_T_OS_DIAS = "0 0 6,18 * * *";
    private static final String NO_NATA_25_DEZ_TODOS_OS_ANOS = "0 0 0 25 12 ?";
